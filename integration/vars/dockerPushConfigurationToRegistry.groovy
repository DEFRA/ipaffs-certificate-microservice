...
def call(String serviceName, String branchName, boolean isMasterRelease, String subscription, String version) {
    ...
    echo "Pushing configuration container"

    def dockerNameTag = DockerName.getConfigurationNameAndTag(branchName, serviceName, subscription, version, isMasterRelease, this)
