...
import static uk.gov.defra.tracesx.integration.certificate.helpers.JwtConstants.EXP;
...
public class SelfSignedTokenClient {
  ...
  private String createUrl(TokenType tokenType, String path) {
    return Properties.TEST_OPENID_TOKEN_SERVICE_URL + tokenType.getPrefix() + path;
  }
