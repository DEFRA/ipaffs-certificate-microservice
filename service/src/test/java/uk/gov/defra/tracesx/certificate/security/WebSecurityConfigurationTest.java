...
public class WebSecurityConfigurationTest {
  ...
  public void whenBasicAuthConfigIsCalledReturnsValidConfiguration() throws Exception {
    ...
    ReflectionTestUtils.setField(
        testee, AUTHENTICATION_CONFIGURATION, authenticationConfigurationMock);
    ReflectionTestUtils.setField(testee, JWT_TOKEN_FILTER, jwtTokenFilter);
    ...
    final List<ArrayList> urlMappings =
        (ArrayList)
