...
public class PermissionsServiceTest {
    ...
    @Before
    public void setup() {
        ReflectionTestUtils.setField(permissionsService, "permissionsUser", USER);
        ReflectionTestUtils.setField(permissionsService, "permissionsPassword", PASSWORD);
        ReflectionTestUtils.setField(permissionsService, "securityTokenFeatureSwitch", TRUE);
